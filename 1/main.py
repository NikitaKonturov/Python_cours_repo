...
def main():
    ...
    # Распаришиваем аргументы 
        ...
        symbolCount = word_statistics.get_text_length(text)
        print("##############################################")
        print(f"Количество символов:\nС учётом пробелов: {symbolCount[0]}\nБез учёта пробелов: {symbolCount[1]}\n##############################################")
       ...
       # print("Общее количество слов:", wordsCount, "\n##############################################")
        print(f"Количество чисел: {word_statistics.get_numbers_count(text=text)}\n##############################################")
        ...
        print("Распределение букв:")
        letters_freq = word_statistics.get_letters_statistics(text=text)
        for i in letters_freq:
            if i == '\n': continue
            print(f"\'{i}\'={letters_freq[i]}")
